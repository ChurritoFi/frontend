  ...
  const features = [
    {
      ...
      subtext:
        "Start earning rewards with as low as 1 CELO in your wallet. The more you hold & stake, the more you earn.",
    },
    {
      asset: <FeatureIllustrationTwo />,
      heading: "Earn Automatically",
      subtext:
        "The CELO rewards automatically get added to your staked CELO for compounding.",
    },
    {
